...
class Stagenet(nn.Module):
    def __init__(self, config, hidden_dim=384, conv_size=10, levels=3, dropout=0.3, dropconnect = 0.3, dropres=0.3):
    ...
    def padMatrixWithoutTime(self, seqs):
        ...
        x = np.zeros([n_samples, maxlen, self.input_dim]).astype(np.float32)
